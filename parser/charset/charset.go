...
var (
	ErrUnknownCollation         = terror.ClassDDL.NewStdErr(mysql.ErrUnknownCollation, mysql.MySQLErrName[mysql.ErrUnknownCollation])
	ErrCollationCharsetMismatch = terror.ClassDDL.NewStdErr(mysql.ErrCollationCharsetMismatch, mysql.MySQLErrName[mysql.ErrCollationCharsetMismatch])
)
