...
const (
	...
	// Set this threshold to prevent innerSideEstCount being too large and causing a performance and memory regression.
	...
	// Set this threshold to prevent innerSideEstCount being too small and causing a performance regression.
	estCountMinFactor = 8

	// estCountDivisor defines the divisor of innerSideEstCount.
	// Set this divisor to prevent innerSideEstCount being too large and causing a performance regression.
	estCountDivisor = 8
)
